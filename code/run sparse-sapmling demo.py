from supporting_function2 import *
import re
...
#                                                          #
############################################################
INPUT_TIFF_PATH = r"D:\bio_inf\02 MSI\20260509空蛋\上传数据\demo\HE"
MODEL_WEIGHTS = r"D:\bio_inf\02 MSI\20260509空蛋\上传数据\weights of SRP\sparse-sampling reconstruction.pth"
...
for i, tiff_file in enumerate(tiff_files, 1):
    ...
    try:
        ...
        process_msi_file2(input_file=INPUT_XLS, target_dpi=downsampling_dpi,
                            target_mz=None,
...
def main_predict_and_stitch(GRID_POSTPROCESS="none", stride_px=24,
    ...
    MODEL_WEIGHTS = MODEL_WEIGHTS
    OUTPUT_DIR = INPUT_TIFF_PATH.replace('HE', 'HE/sparse-sampling preview')
